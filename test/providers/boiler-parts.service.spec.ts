...
describe('Auth service', () => {
  ...
  it('should find by name', async () => {
    const part = await boilerPartsService.findOneByName('Doloremque tenetur.')
    expect(part.dataValues).toEqual(
        expect.objectContaining({
  ...
  it('should find by search string', async () => {
    ...
    parts.rows.forEach(e => {
      expect(e.name.toLowerCase()).toContain('nos')
      expect(e.dataValues).toEqual(
        expect.objectContaining({
            id:  expect.any(Number),
            price: expect.any(Number),
            boiler_manufacturer: expect.any(String),
